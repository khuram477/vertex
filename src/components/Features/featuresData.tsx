...
const featuresData: Feature[] = [
  ...
  height="41"
  viewBox="0 0 40 41"
  style={{ fill: '#246292' }}  // Inline style to change the color
...
>
  <path
    ...
    className="icon-path"
    style={{ fill: '#246292' }}  // Change color for this path
  />
  <path
    ...
    className="icon-path"
    style={{ fill: '#246292' }}  // Change color for this path as well
  />
</svg>
    ),
    
    title: "Personalservice",
    paragraph: "Wir stellen qualifiziertes und zuverlässiges Personal für Ihre geschäftlichen Anforderungen bereit – schnell, flexibel und branchenspezifisch angepasst.",
